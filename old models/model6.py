...
def get_hybrid_recommendations(model, trainset, ratings, movies, links, tags_grouped, cosine_sim, movie_indices, user_id, n=10):
    try:
        ...
        if not user_ratings.empty:
            ...
            # Fallback to popular movies if user has no ratings
            content_recs = get_content_recommendations(1, tags_grouped, cosine_sim, movie_indices, movies, links, ratings, n=n*2)
            content_recs = content_recs.rename(columns={'predicted_rating': 'content_score'})
        ...
        return get_content_recommendations(1, tags_grouped, cosine_sim, movie_indices, movies, links, ratings, n=n)
